...
export default function App() {
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-6 p-8">
      <h1 className="text-3xl font-bold text-accent">RainySteamRecord</h1>
      <p className="text-text-muted">Steam Recording Browser &amp; Exporter</p>
      ...
      {events.length > 0 && (
        <div className="w-full max-w-md rounded-lg border border-border bg-surface p-4">
          <p className="mb-2 text-sm text-text-muted">Sidecar events:</p>
